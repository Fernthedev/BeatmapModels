...
using var jsonReader2 = new JsonTextReader(streamReader);
...
Console.WriteLine($"Deserialized beatmap and serialized beatmap are identical 🎉. Took {stopwatch.ElapsedMilliseconds}ms");

bool CheckObject(JToken jToken1, JToken jToken2)
{
