...
{
    public V3Note(IDictionary<string, JToken>? unserializedData, float time, V3NoteCustomData? typedCustomData, int lineIndex, int lineLayer, int angleOffset, int type, int cutDirection) : base(unserializedData, time, typedCustomData, lineIndex, lineLayer)
    {
